...
export function createShape(overrides: Partial<CollisionShape> = {}): CollisionShape {
  ...
  return {
    ...
    markerColor,
    markerColorSource,
    minX: clampCollisionCoordinate(overrides.minX ?? 0),
    minY: clampCollisionCoordinate(overrides.minY ?? 0),
    minZ: clampCollisionCoordinate(overrides.minZ ?? 0),
    maxX: clampCollisionCoordinate(overrides.maxX ?? 2),
    maxY: clampCollisionCoordinate(overrides.maxY ?? 2),
    maxZ: clampCollisionCoordinate(overrides.maxZ ?? 2),
